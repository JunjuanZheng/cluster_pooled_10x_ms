...
#g8_WT.SAL_HET.SAL <- deGroups(data.combined, "8_WT.SAL", "8_HET.SAL")
#g2_WT.SAL_HET.SAL <- deGroups(data.combined, "2_WT.SAL", "2_HET.SAL")
#g5_WT.SAL_HET.SAL <- deGroups(data.combined, "5_WT.SAL", "5_HET.SAL")
### on neurons
...
#g1_WT.SAL_HET.SAL <- deGroups(data.combined, "1_WT.SAL", "1_HET.SAL")
#g11_WT.SAL_HET.SAL <- deGroups(data.combined, "11_WT.SAL", "11_HET.SAL")
...
#g26_WT.SAL_HET.SAL <- deGroups(data.combined, "26_WT.SAL", "26_HET.SAL")
#g16_WT.SAL_HET.SAL <- deGroups(data.combined, "16_WT.SAL", "16_HET.SAL")
#g18_WT.SAL_HET.SAL <- deGroups(data.combined, "18_WT.SAL", "18_HET.SAL")
...
#g23_WT.SAL_HET.LPS <- deGroups(data.combined, "18_WT.SAL", "28_HET.LPS")


## comparison between groups
#g13_WT.SAL_g25_WT.SAL <- deGroups(data.combined, "13_WT.SAL", "25_WT.SAL")
#g13_WT.SAL_g18_WT.SAL <- deGroups(data.combined, "13_WT.SAL", "18_WT.SAL")
...
#bigDiff_8_wt.sal_het.sal <- plotOneGroup(data.combined, "8", 'WT.SAL', 'HET.SAL', row.names(g8_WT.SAL_HET.SAL[g8_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
#bigDiff_0_wt.sal_het.sal <- plotOneGroup(data.combined, "0", 'WT.SAL', 'HET.SAL', row.names(g0_WT.SAL_HET.SAL[g0_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
#bigDiff_2_wt.sal_het.sal <- plotOneGroup(data.combined, "2", 'WT.SAL', 'HET.SAL', row.names(g2_WT.SAL_HET.SAL[g2_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
#bigDiff_5_wt.sal_het.sal <- plotOneGroup(data.combined, "5", 'WT.SAL', 'HET.SAL', row.names(g5_WT.SAL_HET.SAL[g5_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
## on neurons
#bigDiff_1_wt.sal_het.sal <- plotOneGroup(data.combined, "1", 'WT.SAL', 'HET.SAL', row.names(g1_WT.SAL_HET.SAL[g7_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
#bigDiff_11_wt.sal_het.sal <- plotOneGroup(data.combined, "11", 'WT.SAL', 'HET.SAL', row.names(g11_WT.SAL_HET.SAL[g7_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
...
#bigDiff_26_wt.sal_het.sal <- plotOneGroup(data.combined, "26", 'WT.SAL', 'HET.SAL', row.names(g26_WT.SAL_HET.SAL[g26_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
#bigDiff_16_wt.sal_het.sal <- plotOneGroup(data.combined, "16", 'WT.SAL', 'HET.SAL', row.names(g16_WT.SAL_HET.SAL[g16_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
#bigDiff_15_wt.sal_het.sal <- plotOneGroup(data.combined, "15", 'WT.SAL', 'HET.SAL', row.names(g15_WT.SAL_HET.SAL[g15_WT.SAL_HET.SAL$p_val_adj < 0.05,] ) )
## on microglia
...
plotFeatureHeatmap(data.combined, c('Cntnap2', 'Foxg1', 'Sp8', 'Nr2f1'), "cond", 'FeatureHeatmap_regBy16p_InterneuronMarkersOfInterest_A', chosen_res, chosen_cc ) #!!!
plotFeatureHeatmap(data.combined, c('Nkx2-1', 'Otx2', 'Lhx6', 'Lhx8'), "cond", 'FeatureHeatmap_regBy16p_InterneuronMarkersOfInterest_B', chosen_res, chosen_cc ) #!!!
...
plotVlnPlot(data.combined, 'Foxg1', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
plotVlnPlot(data.combined, 'Cntnap2', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
plotVlnPlot(data.combined, 'Cntnap1', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
plotVlnPlot(data.combined, 'Nr2f1', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
plotVlnPlot(data.combined, 'Nkx2-1', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
plotVlnPlot(data.combined, 'Lhx6', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
plotVlnPlot(data.combined, 'Lhx8', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
#plotVlnPlot(data.combined, 'Couptf1', 'cond', 'plotVlnPlot', chosen_res, chosen_cc)
