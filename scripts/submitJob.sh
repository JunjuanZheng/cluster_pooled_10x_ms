...
#Rscript cca_makeVars.R $MTX_16p_SC_MS $METADAT_16p_SC_MS $OUTPUT_16p/201901_cluster_pooled_10x_ms/20190213/

## Order of variables: (1)Folder containin .mtx data from 10x, (2) Metadata.csv, (3) output loc                                                                                                   #Rscript cca_ccaAndTSNE.R $OUTPUT_16p/201901_cluster_pooled_10x_ms/20190213/
